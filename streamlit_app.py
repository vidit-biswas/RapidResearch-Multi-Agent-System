...
st.set_page_config(
    page_title="RapidResearch · AI Research Agent",
    page_icon="🔬",
    layout="wide",
...
.stApp {
    ...
    background-image:
        ...
        radial-gradient(ellipse 60% 40% at 80% 110%, rgba(185,28,28,0.08) 0%, transparent 55%);
}
...
.step-card.active::before { background: #e53935; }
...
.stSpinner > div { color: #e53935 !important; }
...
<div class="hero">
    ...
    <h1>Rapid<span>Research</span></h1>
    <p class="hero-sub">
...
st.markdown("""
<div class="notice">
    RapidResearch · Powered by LangChain multi-agent streamlit run app.pypipeline · Built with ❤️ by Vidit Biswas
</div>
""", unsafe_allow_html=True)
